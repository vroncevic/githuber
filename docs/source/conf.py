...
Module
    conf.py
Copyright
    Copyright (C) 2017 - 2024 - 2024-2024 Vladimir Roncevic <elektron.ronca@gmail.com>
    githuber is free software: you can redistribute it and/or modify it
    under the terms of the GNU General Public License as published by the
    Free Software Foundation, either version 3 of the License, or
    (at your option) any later version.
    githuber is distributed in the hope that it will be useful, but
...
htmlhelp_basename: str = 'githuberdoc'
latex_elements: Dict[Any, Any] = {}
latex_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'githuber.tex', 'githuber Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: List[Tuple[Any, ...]] = [(
    master_doc, 'githuber', 'githuber Documentation', [author], 1
)]
texinfo_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'githuber', 'githuber Documentation', author, 'githuber',
